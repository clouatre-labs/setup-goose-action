# Contributing to setup-goose-action
...
```bash
git clone https://github.com/YOUR_USERNAME/setup-goose-action.git
...
```bash
git commit -S --signoff -m "feat(action): add arm64 support"
```
...
- Default install on Ubuntu x64 and arm64
